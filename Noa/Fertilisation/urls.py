...
urlpatterns = [
    ...
    path('create', views.create_fertilisation, name='create'),
    path('list', views.fertilisation_list, name='fertilisation_list'),
    path('detail/<int:pk>', views.fertilisation_detail, name='fertilisation_detail'),
    path('<int:pk>/update', views.update_fertilisation, name='update_fertilisation'),
    path('<int:pk>/delete', views.delete_fertilisation, name='delete_fertilisation'),


    path('create_M', views.create_ModéleVraiante, name='create_M'),
    path('list_M', views.Modéle_list, name='list_M'),
    path('<int:pk>', views.modèle_details, name='Modéle_detail'),
    path('<int:pk>/update_M', views.edit_modéle, name='update_Modéle'),
    path('<int:pk>/delete_M', views.delete_modéle, name='delete_Modéle'),
    #path('<int:pk>', views.saisie_etapes, name='saisieEtape'),
    path('saisie_etapes/<int:pk>/', views.saisie_etapes, name='saisie_etapes'),
